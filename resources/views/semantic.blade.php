    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false"
                ...
                <li class="nav-item start ">
                    <a href="{{url('passport')}}" class="nav-link nav-toggle">
                        <i class="icon-home"></i>
                        <span class="title">جوازات السفر</span>
                        <span class="arrow"></span>
                    </a>
                </li>
                <li class="nav-item start ">
                    <a href="{{url('followup')}}" class="nav-link nav-toggle">
                        <i class="icon-home"></i>
                        <span class="title">المراجعات</span>
                        <span class="arrow"></span>
                    </a>
                </li>
                <li class="nav-item start ">
                    <a href="{{url('medicine')}}" class="nav-link nav-toggle">
                        <i class="icon-home"></i>
                ...
                <li class="nav-item start ">
                    <a href="{{url('billing')}}" class="nav-link nav-toggle">
                        <i class="icon-home"></i>
                        <span class="title">الملف المالي</span>
                        <span class="arrow"></span>
                    </a>
                </li>
            </ul>
        ...
        function showModal(formName, id) {
            ...
            if (id == null) {
                ...
                $.get('{{url('')}}' + "/" + formName + '/' + id + "/edit", function (data) {
                    console.log(data)
                    if (data) {
                        var selects = form.find('.select2-container').serializeArray()
                        var inputs = form.find('textarea,input').serializeArray();
                        $.each(selects, function (i, field) {
                            var fieldName = field.name

                            $('#' + formName + 'Form').find('[name="' + fieldName + '"]').val(data[fieldName]).trigger('change');
                        });
                        $.each(inputs, function (i, field) {
